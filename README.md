...
2) When prompted with the following screen, wait until the application is done creating the tunnel.
<img width="431" height="642" alt="image" src="https://github.com/user-attachments/assets/3505a3da-96ea-4812-96a6-cf2d5b8cea49" />
3) Once the tunnel is done you can either copy the link or exit privacy mode to follow the link or QR code.
